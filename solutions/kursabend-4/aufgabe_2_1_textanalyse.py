...
def zeige_analyse(ergebnis):
    ...
    print(
        f"Durchschnittliche Wortlänge: {ergebnis['durchschnitt_wortlaenge']:.1f} Zeichen"
    )
    print(
        f"Längstes Wort:               {ergebnis['laengstes_wort']} ({len(ergebnis['laengstes_wort'])} Zeichen)"
    )
    print(
        f"Häufigstes Wort:             {ergebnis['haeufigste_wort']} ({ergebnis['haeufigste_anzahl']} mal)"
    )
    print("=" * 60)
